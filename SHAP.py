...
#
# 请按你的实际文件夹修改。
PLM1_EMBEDDING_DIR = r"E:/fengzhen/embedding_PPI/ProstT5_embedding_352_70"
PLM2_EMBEDDING_DIR = r"E:/fengzhen/embedding_PPI/Ankh_embedding_352_70"


# ---------- 五个重复运行得到的 checkpoint ----------
CHECKPOINT_PATHS = [
    r"E:/fengzhen/NucGMTL-main/RGMTL/Result_PPI_0_2026-06-22 10_49_25.912853.pkl",
    r"E:/fengzhen/NucGMTL-main/RGMTL/Result_PPI_1_2026-06-22 10_49_25.912853.pkl",
    r"E:/fengzhen/NucGMTL-main/RGMTL/Result_PPI_2_2026-06-22 10_49_25.912853.pkl",
    r"E:/fengzhen/NucGMTL-main/RGMTL/Result_PPI_3_2026-06-22 10_49_25.912853.pkl",
    r"E:/fengzhen/NucGMTL-main/RGMTL/Result_PPI_4_2026-06-22 10_49_25.912853.pkl",
]
...
class MeanPositiveLogitForSHAP(nn.Module):
    ...
    def forward(self, x_in):
        ...
        logits = self.model(x_in, fixed_lengths)  # [B, L, 2]

        positive_logits = logits[..., 1]          # [B, L]

        # GradientExplainer 要求输出至少二维
        return positive_logits.mean(dim=1, keepdim=True)

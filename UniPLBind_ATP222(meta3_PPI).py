...
def read_data_file_trip(istraining):
    ...
    if istraining:
        # file_path = 'D:/fengzhen/1NucGMTL-main/DataSet/SMB/SMB_Train.txt'
        file_path = 'E:/fengzhen/1NucGMTL-main/DataSet/PPI/Train352-Test70/PPI-Train352.txt'
    else:
        file_path = 'E:/fengzhen/1NucGMTL-main/DataSet/PPI/Train352-Test70/PPI-Test70.txt'
...
class BioinformaticsDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        df0 = pd.read_csv('E:/fengzhen/5embedding/ProstT5_embedding_352+70/' + filename + '.data', header=None)
        prot0 = df0.values.astype(float).tolist()
        prot0 = torch.tensor(prot0)

        df1 = pd.read_csv('E:/fengzhen/5embedding/Ankh_embedding_352+70/' + filename + '.data', header=None)
        ...
        df2 = pd.read_csv('E:/fengzhen/5embedding/label/' + filename + '.label', header=None)

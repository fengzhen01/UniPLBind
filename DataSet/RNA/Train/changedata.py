    ...
    with open(input_file, 'r') as f_in, open(output_file, 'w') as f_out:
        while True:
            ...
            if '_' in header:
                ...
                processed_header = f"{base_id}{num}_RNA"  # 合并成 "4csu2_RNA"
            else:
                processed_header = f"{header}_RNA"  # 如果没有下划线，直接加 "_RNA"
...
# 使用示例
input_filename = "RNA-495_Train.txt"  # 替换为你的输入文件名
output_filename = "RNA_Train.txt"  # 替换为你想要的输出文件名
